...
class WPSR_Admin{
    ...
    public static function admin_footer(){
        ...
        <a class="button button-primary buy_coffee_btn" href="https://www.paypal.me/vaakash/7" data-link="https://www.paypal.me/vaakash/" target="_blank">Buy me a coffee !</a>
        </div>
        ';
