...
jQuery(document).ready(function(){
    ...
    var scr_templates = [
        ["Color icons", "32px,icon-white,pad,zoom", "no"],
        ["Color icons", "32px,icon-white,zoom", "no"],
        ["Color icons", "32px,icon-white,circle,pad,zoom", "no"],
        ["Color icons", "32px,icon-white,squircle,pad,zoom", "no"],
        ["Color icons", "32px,icon-white,diamond,pad,zoom", "no"],
        ["Color icons", "32px,icon-white,ribbon,pad,zoom", "no"],
        ["Color icons", "32px,icon-white,drop,pad,zoom", "no"],
        ["Color icons with shadow", "32px,icon-white,pad,sw-icon-1,zoom", "no"],
        ["Color icons with shadow", "32px,icon-white,pad,sw-2,zoom", "no"],
        
        ["Just icons", "32px,bg-none,pad,zoom", "no"],
        ["Just icons", "32px,bg-none,icon-dark,pad,zoom", "no"],
        ["Just icons", "32px,bg-none,icon-grey,pad,zoom", "no"],
        ["Just icons with shadow", "32px,bg-none,sw-icon-1,pad,zoom", "no"],
        ["Just icons with shadow", "32px,bg-none,icon-dark,sw-icon-1,pad,zoom", "no"],
        ["Just icons with shadow", "32px,bg-none,icon-grey,sw-icon-1,pad,zoom", "no"],
        
        ["Fixed background", "32px,icon-white,bg-dark,pad,zoom", "no"],
        ["Fixed background", "32px,bg-dark,circle,pad,zoom", "no"],
        ["Fixed background", "32px,icon-white,bg-dark,squircle-2,pad,zoom", "no"],
        
        ["Fixed background", "32px,icon-dark,bg-white,pad,zoom", "no"],
        ["Fixed background", "32px,bg-white,circle,sw-1,pad,zoom", "no"],
        ["Fixed background", "32px,icon-dark,bg-white,drop,sw-2,pad,zoom", "no"],
        
        ["Fixed background", "32px,diamond,icon-dark,bg-grey,pad,zoom", "no"],
        ["Fixed background", "32px,bg-grey,circle,sw-1,pad,zoom", "no"],
        ["Fixed background", "32px,icon-dark,bg-grey,squircle-2,sw-2,pad,zoom", "no"],
        
        ["Icon and border", "32px,bdr-md,bg-none,pad,zoom", "no"],
        ["Icon and border", "32px,bdr-md,bg-none,circle,pad,zoom", "no"],
        ["Icon and border", "32px,bdr-md,bg-none,squircle-2,pad,zoom", "no"],
        
        ["Icon and border", "32px,bdr-md,bg-none,bdr-dark,icon-dark,pad,zoom", "no"],
        ["Icon and border", "32px,bdr-md,bg-none,bdr-dark,icon-dark,circle,pad,zoom", "no"],
        ["Icon and border", "32px,bdr-md,bg-none,bdr-dark,icon-dark,squircle-2,pad,zoom", "no"],
        
        ["Icon and border", "32px,bdr-md,bdr-dark,icon-white,sw-icon-1,pad,zoom", "no"],
        ["Icon and border", "32px,bdr-md,bdr-color,icon-color,bg-dark,pad,zoom", "no"],
        ["Icon and border", "32px,bdr-md,bdr-color,icon-dark,bg-grey,squircle,pad,zoom", "no"],
        
        ["Mixed", "32px,bg-white,bdr-md,bdr-grey,circle,pad,zoom", "no"],
        ["Mixed", "32px,bg-white,bdr-md,bdr-dark,squircle-2,pad,zoom", "no"],
        ["Mixed", "32px,icon-white,bdr-md,bdr-dark,drop,sw-3,pad,zoom", "no"],
        
        ["Ribbons", "32px,icon-white,sw-icon-1,ribbon,pad,zoom", "no"],
        ["Ribbons", "32px,icon-white,bg-dark,bdr-dark,ribbon,pad,zoom", "no"],
        ["Ribbons", "32px,icon-dark,bg-grey,bdr-grey,ribbon,pad,zoom", "no"],
        ...
        ["Fluid Icons", "32px,icon-white,squircle,fluid,pad,zoom", "no"],
        ["Fluid Icons", "32px,icon-white,fluid,zoom", "no"],
        ["Fluid Icons", "32px,icon-white,sw-icon-1,fluid,zoom", "no"],
        ["Fluid Icons", "32px,icon-white,sw-2,pad,fluid,zoom", "no"],
        ["Fluid Icons", "32px,icon-white,bg-dark,fluid,pad,zoom", "no"],
        ["Fluid Icons", "32px,bg-none,fluid,zoom", "no"],
        ["Fluid Icons", "32px,bg-none,fluid", "in"],
        
        ["Vertical", "32px,icon-white,vertical,pad,zoom", "no"],
        ["Vertical", "32px,bdr-md,bg-none,squircle-2,vertical,pad,zoom", "no"],
        ["Vertical", "32px,bg-dark,circle,vertical,pad,zoom", "no"],
        ["Vertical", "32px,bdr-md,bdr-dark,icon-white,sw-icon-1,squircle,vertical,pad,zoom", "no"],
        ["Vertical", "32px,icon-white,bg-dark,vertical,pad,zoom", "no"],
        ["Vertical", "32px,bg-none,pad,vertical,zoom", "no"],
        ["Vertical", "32px,bg-none,icon-dark,pad,vertical,zoom", "no"],
        ["Vertical", "32px,icon-white,vertical,zoom", "no"],
    ];
