...
class wpsr_service_share_counter{
    ...
    function settings( $values ){
        ...
        echo '<div class="notice notice-warning"><p>' . __( 'Please note that the share count values are cached on the server side. Hence inorder to retrieve the share count, the very first page load may take time.' ) . '</p></div>';
