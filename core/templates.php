    ...
    public static function html( $opts, $page_info = array() ){
        ...
        foreach( $rows as $row ){
            if( count( $row->buttons ) > 0 ){
                ...
                $html .= '</div>';
                $html .= '<div class="wpsr-sb-close" title="Open or close sharebar"><span class="fa wpsr-arrow"></span></div>';
                $html .= '</div>';
            }
            break;
        }
...
class WPSR_Template_Followbar{
    ...
    public static function html( $opts, $floating = True ){
        ...
        if( $floating ){
            ...
            $close_btn = '<div class="wpsr-fb-close" title="Toggle"><span class="fa wpsr-arrow"></span></div>';
