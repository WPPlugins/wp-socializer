...
class WPSR_Location_Rules{
    ...
    public static function check_rule( $rule_wrap ){
        ...
        if( wp_is_mobile() && $rule_wrap[ 'hide_in_mobile' ] == '1' ){
            return 0;
        }
    ...
    public static function display_rules( $id, $values = array() ){
        ...
        echo '<div class="loc_rules_sec2">';
        echo '<label>';
        echo WPSR_Admin::field( 'checkbox', array(
            'name' => $id . '[hide_in_mobile]',
            'value' => $values[ 'hide_in_mobile' ],
            'default' => ''
        ));
        echo __( 'Hide in mobile devices', 'wpsr' ) . '</label>';
        echo '</div>';
